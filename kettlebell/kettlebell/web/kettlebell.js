fetch("/api/arak")
    ...
    .then(data => {
        ...
        document.getElementById("kedvezmenyListaElem").innerHTML = `<span class="fa-li"><i class="fas fa-check"></i></span>${data["kedvezmeny"]}%-os
...
function gyakorlatGeneralas() {
    ...
    document.getElementById("generaltGyakorlat").innerHTML = `<span class="fa-li"><i class="fas fa-check"></i></span>${gyakorlat} - ${ismetlesSzam} darab`;
}
